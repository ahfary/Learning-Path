...
**HTML** (*HyperText Markup Language*) adalah standar bahasa markah yang digunakan untuk membuat kerangka halaman web. 

:::warning Miskonsepsi Umum
HTML **bukan** bahasa pemrograman. HTML tidak memiliki logika (*if/else*), variabel, atau fungsi aritmatika. Ia hanya bertugas memberi tahu browser: "Ini adalah judul", "Ini adalah paragraf", atau "Ini adalah gambar".
:::
...
2.  **CSS (Kulit/Pakaian):** Memberikan tampilan visual dan estetika.
